...
![Module 02 Cover Image](https://i.imgur.com/your-ros2-image-here.png) <!-- Replace with actual image link -->
...
```mermaid
graph TD
    A[02 The Robotic Nervous System (ROS 2)] --> B(01 ROS 2 Fundamentals)
    A --> C(02 ROS 2 Nodes, Topics, and Services)
    A --> D(03 ROS 2 Actions and Parameters)
```
