...
```mermaid
graph TD
    A[05 Vision-Language-Action Models & The Autonomous Humanoid] --> B(01 VLA Fundamentals)
    A --> C(02 Voice-to-Action Pipeline)
    A --> D(03 OpenVLA, RTX, and Project Helix)
    A --> E(04 Full VLA Stack Integration)
    A --> F(05 Capstone: The Autonomous Humanoid)
```
