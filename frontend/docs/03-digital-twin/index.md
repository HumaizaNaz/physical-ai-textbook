...
![Module 03 Cover Image](/img/03-digital-twin.png) <!-- Replace with actual image link -->
...
```mermaid
graph TD
    A[03 Digital Twin] --> B(01 Gazebo Simulation)
    A --> C(02 Unity Robotics)
    A --> D(03 URDF & XACRO Modeling)
```
